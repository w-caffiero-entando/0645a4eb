(window['webpackJsonpconference-details-widget'] =
  ...
  [
    ...
    function(e, t, n) {
      ...
      function S() {
        ...
        ('string' === typeof t[0] && E[t[0]]) ||
          ('string' === typeof t[0] && (E[t[0]] = new Date()), k.apply(void 0, t));
      }
      function O(e, t, n) {
    ...
    function(e, t, n) {
      e.exports = { parse: n(80), stringify: n(83) };
    },
    function(e, t) {
      e.exports = function(e, t) {
        if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
    ...
    function(e, t, n) {
        ...
        var Yt = Vt.extend({
          ...
          en = Vt.extend({
            ...
            movementX: function(e) {
              ...
              var t = Gt;
              return (
                (Gt = e.screenX), Jt ? ('mousemove' === e.type ? e.screenX - t : 0) : ((Jt = !0), 0)
              );
            },
            movementY: function(e) {
              ...
              var t = Xt;
              return (
                (Xt = e.screenY), Zt ? ('mousemove' === e.type ? e.screenY - t : 0) : ((Zt = !0), 0)
              );
            },
          }),
          tn = en.extend({
          ...
          extractEvents: function(e, t, n, r) {
            ...
            return (
              ...
              (e = Or
                ? (function(e, t) {
                    switch (e) {
                      case 'compositionend':
                        return Nr(t);
                      case 'keypress':
                        return 32 !== t.which ? null : ((Pr = !0), jr);
                      case 'textInput':
                ...
                : (function(e, t) {
                    if (_r)
                      return 'compositionend' === e || (!Er && Rr(e, t))
      ...
      var ji = o.unstable_runWithPriority,
      ...
      function Gi(e) {
        return null === Vi ? ((Vi = [e]), (Wi = Ci(Li, Ji))) : Vi.push(e), Di;
      }
      function Xi() {
        if (null !== Wi) {
          var e = Wi;
      ...
      function Ji() {
        if (!Bi && null !== Vi) {
          ...
          try {
            ...
            throw (null !== Vi && (Vi = Vi.slice(e + 1)), Ci(Li, Xi), n);
          } finally {
            Bi = !1;
          }
        }
        ...
        if ((co(t, i), null === t.stateNode))
          ...
          null !== p && (ko(t, p, r, a, i), (u = t.memoizedState)),
            l !== r || d !== u || vi.current || po
              ? ('function' === typeof c && (jo(t, n, c, r), (u = t.memoizedState)),
          ...
          (a = t.stateNode),
            ...
            l !== r || u !== d || vi.current || po
              ? ('function' === typeof c && (jo(t, n, c, r), (d = t.memoizedState)),
      ...
      function al(e, t, n) {
        ...
        if (
          ...
          if ((void 0 !== o.fallback && Ua(t), l)) {
            if (((l = o.fallback), ((o = Gu(null, i, 0, null)).return = t), 0 === (2 & t.mode)))
              for (
      ...
      function vu(e, t) {
        ...
        return null !== i && ($l === i && (Cu(t), Ql === Wl && ts(i, ql)), ns(i, t)), i;
      }
      function yu(e) {
      ...
      function Ou(e, t) {
        for (;;) {
          try {
            if ((ao(), ma(), null === Kl || null === Kl.return)) return (Ql = Dl), (Yl = t), null;
            e: {
              var n = e,
                r = Kl.return,
                i = Kl,
      ...
      function Du(e, t, n) {
        yo(e, (t = Cl(e, (t = hl(n, t)), 1073741823))), null !== (e = vu(e, 1073741823)) && bu(e);
      }
      function Uu(e, t) {
        if (3 === e.tag) Du(e, e, t);
        else
      ...
      function Vu(e, t, n) {
        ...
        null !== r && r.delete(t),
          $l === e && ql === n
            ? Ql === Wl || (Ql === Vl && 1073741823 === Gl && $i() - tu < nu)
              ? Su(e, ql)
              : (eu = !0)
            : es(e, n) &&
    ...
    function(e, t, n) {
      ...
      function U(e, n) {
        ...
        var r = L;
        try {
          for (F(n), M = j(R); null !== M && (!(M.expirationTime > n) || (e && !a())); ) {
            var l = M.callback;
            if (null !== l) {
              (M.callback = null), (L = M.priorityLevel);
              var u = l(M.expirationTime <= n);
              (n = t.unstable_now()),
                'function' === typeof u ? (M.callback = u) : M === j(R) && C(R),
                F(n);
            } else C(R);
            M = j(R);
          }
        ...
        (t.unstable_scheduleCallback = function(e, n, a) {
          ...
          return (
            ...
            u > l
              ? ((e.sortIndex = u),
                T(N, e),
                null === j(R) && e === j(N) && (I ? o() : (I = !0), i(D, u - l)))
      ...
      var r = n(2),
        ...
        p = a.a.forwardRef(function(e, t) {
          ...
          var S = m || (w && w.padding ? w.padding : 'default'),
            O = v || (w && w.size ? w.size : 'medium'),
            T = b || (k && k.variant),
            j = null;
          return (
            y && (j = 'asc' === y ? 'ascending' : 'descending'),
            a.a.createElement(
              n,
              Object(i.a)(
                {
    ...
    function(e, t, n) {
        ...
        M = (function() {
          function e(e, t, n) {
            ...
            var o = n.scoped,
              a = n.sheet,
              l = n.generateId;
            for (var u in ((this.id = !1 === o ? this.name : k(l(this, a))),
            (this.rules = new G(Object(i.a)({}, n, { parent: this }))),
            t))
      ...
      function Xe(e, t, n) {
        ...
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) t[r] = Xe(e, t[r], n);
          ...
          if ('fallbacks' === e) for (var i in t) t[i] = Xe(i, t[i], n);
      ...
      if (u) {
        ...
        for (var Ft in It) isNaN(Ft) || (At[It[Ft]] = It[Ft]);
      ...
      t.a = function(e) {
        ...
        return (
          ...
          function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              t = Object(we.a)() || s,
              r = Object(i.a)({}, a.a.useContext(Xt), {}, c),
              o = a.a.useRef(),
              u = a.a.useRef();
            return (
              sn(
    ...
    function(e, t, n) {
      ...
      var y = s(
        ...
        E = g({ prop: 'boxShadow', themeKey: 'shadows' });
      function S(e) {
        return e <= 1 ? ''.concat(100 * e, '%') : e;
      }
      var O = g({ prop: 'width', transform: S }),
        T = g({ prop: 'maxWidth', transform: S }),
        j = g({ prop: 'minWidth', transform: S }),
        C = g({ prop: 'height', transform: S }),
        P = g({ prop: 'maxHeight', transform: S }),
        R = g({ prop: 'minHeight', transform: S }),
        N =
...
//# sourceMappingURL=2.21649f1a.chunk.js.map
